...
::set SDK_ROOT="D:\TI\sysconfig_1.20.0"
::set SDK_ROOT=%TI_SDK_ROOT%
set TI_SYSCFG_ROOT="D:\TI\sysconfig_1.20.0"
set TI_SDK_ROOT="D:\TI\mspm0_sdk_2_01_00_03"

set SDK_ROOT=%TI_SDK_ROOT%
set SYSCFG_PATH="%TI_SYSCFG_ROOT%\sysconfig_cli.bat"
